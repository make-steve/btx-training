...
$arUrlRewrite = array(
	...
	array(
		"CONDITION" => "#^/site_ou/settings/configs/userconsent/#",
		"RULE" => "",
		"ID" => "",
		"PATH" => "/site_ou/configs/userconsent.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/site_ou/crm/configs/deal_category/#",
		"RULE" => "",
		"ID" => "bitrix:crm.deal_category",
		"PATH" => "/site_ou/crm/configs/deal_category/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/site_ou/crm/configs/automation/#",
		"RULE" => "",
		"ID" => "bitrix:crm.config.automation",
		"PATH" => "/site_ou/crm/configs/automation/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/site_ou/company/personal/mail/#",
		"RULE" => "",
		"ID" => "bitrix:intranet.mail.config",
		"PATH" => "/site_ou/company/personal/mail/index.php",
	),
	array(
		"CONDITION" => "#^/extranet/vgccontacts/personal/#",
		"RULE" => "",
		"ID" => "bitrix:socialnetwork_user",
		"PATH" => "/extranet/vgccontacts/personal.php",
	),
	array(
		"CONDITION" => "#^/site_ou/crm/configs/mycompany/#",
		"RULE" => "",
		"ID" => "bitrix:crm.company",
		"PATH" => "/site_ou/crm/configs/mycompany/index.php",
	),
	array(
		"CONDITION" => "#^/extranet/vgcworkgroups/create/#",
		"RULE" => "",
		"ID" => "bitrix:extranet.group_create",
		"PATH" => "/extranet/vgcworkgroups/create/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^={SITE_DIR.\"mobile/webdav\"}#",
		"RULE" => "",
		"ID" => "bitrix:mobile.webdav.file.list",
		"PATH" => "/mobile/webdav/index.php",
	),
	array(
		"CONDITION" => "#^/extranet/vgcmobile/webdav#",
		"RULE" => "",
		"ID" => "bitrix:mobile.webdav.file.list",
		"PATH" => "/extranet/vgcmobile/webdav/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/test_sitepersonal/order/#",
		"RULE" => "",
		"ID" => "bitrix:sale.personal.order",
		"PATH" => "/test_sitepersonal/order/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/extranet/vgcworkgroups/#",
		"RULE" => "",
		"ID" => "bitrix:socialnetwork_group",
		"PATH" => "/extranet/vgcworkgroups/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/site_ou/crm/webform/#",
		"RULE" => "",
		"ID" => "bitrix:crm.webform",
		"PATH" => "/site_ou/crm/webform/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/site_ou/crm/button/#",
		"RULE" => "",
		"ID" => "bitrix:crm.button",
		"PATH" => "/site_ou/crm/button/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/test_sitecatalog/#",
		"RULE" => "",
		"ID" => "bitrix:catalog",
		"PATH" => "/test_sitecatalog/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/test_sitestore/#",
		"RULE" => "",
		"ID" => "bitrix:catalog.store",
		"PATH" => "/test_sitestore/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/test_sitenews/#",
		"RULE" => "",
		"ID" => "bitrix:news",
		"PATH" => "/test_sitenews/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/site_ou/onec/#",
		"RULE" => "",
		"ID" => "bitrix:crm.1C.start",
		"PATH" => "/site_ou/onec/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/crm/project/#",
		"RULE" => "",
		"ID" => "bitrix:crm.project",
		"PATH" => "/crm/project/index.php",
	),
	array(
