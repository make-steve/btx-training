...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"G_VIDEO_PATH_TO_FILE"=>"118",
		"G_VIDEO_DURATION"=>"119",
		"G_VIDEO_SECTION_ID"=>"3448",
		"G_VIDEO_ELEMENT_ID"=>"7346",
		"G_VIDEO_WIDTH"=>"400",
		"G_VIDEO_HEIGHT"=>"300",
