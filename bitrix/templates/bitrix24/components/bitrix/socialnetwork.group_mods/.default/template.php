				...
				if ($arResult["Moderators"] && $arResult["Moderators"]["List"])
				{
					if ($arResult["CurrentUserPerms"]["UserCanModifyGroup"]):
						?><script>
							...
							window.onload = function() {if (arUsers.length > 0) document.getElementById('bx_owner_link').style.display = 'block';}
						</script>
						<?
						$this->SetViewTarget("sidebar", 60);	
						?>
						<div class="sidebar-links">
							<span id="blank"></span>
							<a href="javascript:void(0)" id="bx_owner_link" onclick="ShowOwnerMenu(this);" style="display: none;"><i class="sidebar-action-owner"></i><b><?echo GetMessage('SONET_C10_T_OWNER')?><span></span></b></a>
						</div>
						<?
						$this->EndViewTarget();
					endif;
