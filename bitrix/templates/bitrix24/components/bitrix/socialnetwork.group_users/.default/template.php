		...
		if ($arResult["Users"] && $arResult["Users"]["List"])
		{
			if ($arResult["CurrentUserPerms"]["UserCanModifyGroup"]):
				...
				<div class="sidebar-links">
					<span id="blank"></span>
					<a href="javascript:void(0)" id="bx_owner_link" onclick="ShowOwnerMenu(this);" style="display: none;"><i class="sidebar-action-owner"></i><b><?echo GetMessage('SONET_C25_T_OWNER')?><span></span></b></a>
				</div>
				<?
				$this->EndViewTarget();
