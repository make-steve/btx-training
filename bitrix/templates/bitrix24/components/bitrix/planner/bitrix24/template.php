...
/*$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . '/components/bitrix/planner/bitrix24/custom_task_planner_handler.js');
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . '/components/bitrix/planner/bitrix24/custom_calendar_planner_handler.js');
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . '/components/bitrix/planner/bitrix24/custom_intranet_core_planner.js');

*/

$APPLICATION->AddHeadScript("https://code.jquery.com/jquery-1.12.4.js");
$APPLICATION->AddHeadScript("https://code.jquery.com/ui/1.12.1/jquery-ui.js");
$APPLICATION->SetAdditionalCSS("/bitrix/js/crm/css/crm.css");
$APPLICATION->SetAdditionalCSS("https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css");
...
(function(){
	...
	BX.addCustomEvent(
		BXPLANNER, 'onCustomPlannerDataRecieved', function(ob, DATA)
		{
	...
	BX.ready(function(){
		BX.bind(BX('timeman-block', true), 'click', function()
		{
			...
			//console.log(BXPLANNER.WND);
			//console.log(BXPLANNER.drawAdditional());
			...
			var getUser = document.getElementsByClassName("user-name");
			var getUserName = getUser[0].innerHTML;

			var getEmployeeName = document.getElementById("tm-employee-name");
			getEmployeeName.innerHTML = getUserName;

			BXPLANNER.drawGridDealTaskList(datadates);

			var availableTags = [];
			var query_data = {
				'method': 'POST',
				'dataType': 'json',
				'url': '/bitrix/templates/bitrix24/components/bitrix/planner/bitrix24/autocompletetask.php',
				'onsuccess': function(data) {
					availableTags = data;

					$( "#tm-popup-dealtask" ).autocomplete({
...
{
	$( "#tm-popup-dealtask" ).bind( "autocompleteclose", function( event, ui ) {
		BXPLANNER.WND.show();
	} );
}
