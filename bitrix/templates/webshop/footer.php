...
<!--Footer -->
    ...
    <script src="<?=CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH."/assets/js/jquery-1.10.2.js")?>"></script>
    <!--bootstrap JavaScript file  -->
    <script src="<?=CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH."/assets/js/bootstrap.js")?>"></script>
    <!--Slider JavaScript file  -->
    <script src="<?=CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH."/assets/ItemSlider/js/modernizr.custom.63321.js")?>"></script>
    <script src="<?=CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH."/assets/ItemSlider/js/jquery.catslider.js")?>"></script>
    <script>
        $(function () {
