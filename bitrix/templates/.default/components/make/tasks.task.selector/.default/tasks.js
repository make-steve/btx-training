...
TasksTask.prototype.search = function(e)
{
	...
	if (this.searchInput.value.length > 1)
	{
		...
		var url = (typeof this.ajaxUrl != 'undefined' ? this.ajaxUrl : TasksTask.ajaxUrl) + '&MODE=SEARCH&SEARCH_STRING=' + encodeURIComponent(this.searchInput.value) + "&" + BX.ajax.prepareData(this.filter, "FILTER");
