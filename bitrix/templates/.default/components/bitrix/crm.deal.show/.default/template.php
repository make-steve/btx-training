...
global $APPLICATION;
Bitrix\Main\Page\Asset::getInstance()->addJs('/bitrix/js/socialnetwork/content_view.js');
Bitrix\Main\Page\Asset::getInstance()->addJs('/bitrix/components/bitrix/socialnetwork.log.entry/templates/.default/scripts.js');
// Bitrix\Main\Page\Asset::getInstance()->addJs('/bitrix/js/socialnetwork/content_view.js');
...
{
	CJSCore::Init(array('uploader', 'file_dialog', 'content_view'));
}
