...
*/
				...
				) // all other events
				{
					?><div class="feed-post-text-block"><?
						...
						if(strripos($arEvent["EVENT_FORMATTED"]["MESSAGE"], "deal closure") !== false) {
							...
							$arEvent["EVENT_FORMATTED"]["MESSAGE"] = str_replace("BX.CrmDealStageManager.messages = {'dialogTitle':'Select the result for the deal closure.','failureTitle':'Deal lost','selectorTitle':'Close deal'}; });", "BX.CrmDealStageManager.messages = {'dialogTitle':'" . $changeOutput . "','failureTitle':'Deal lost','selectorTitle':'Close deal'}; });", $arEvent["EVENT_FORMATTED"]["MESSAGE"]);
						}
