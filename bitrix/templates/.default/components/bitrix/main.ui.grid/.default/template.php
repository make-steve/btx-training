...
if (stripos($APPLICATION->GetCurPage(), '/crm/tasks/')!==false) {
    $formAction = '/crm/tasks/export.php';
...
<div class="main-grid<?=$arResult["IS_AJAX"] ? " main-grid-load-animation" : ""?><?=!$arParams["ALLOW_HORIZONTAL_SCROLL"] ? " main-grid-full" : ""?><?=$arParams["ALLOW_ROWS_SORT"] ? " main-grid-rows-sort-enable" : ""?>" id="<?=$arParams["GRID_ID"]?>" data-ajaxid="<?=$arParams["AJAX_ID"]?>"<?=$arResult['IS_AJAX'] ? " style=\"display: none;\"" : ""?>><?
	?><form name="form_<?=$arParams["GRID_ID"]?>" action="<?=$formAction; ?>" method="POST"><?
		?><?=bitrix_sessid_post() ?><?
									...
									if ($arParams["SHOW_ROW_CHECKBOXES"]): ?><?
										?><td class="main-grid-cell main-grid-cell-checkbox"><?
											?><span class="main-grid-cell-content"><?
												?><input type="checkbox" class="main-grid-row-checkbox main-grid-checkbox <?php echo $customClass;?>" name="ID[]" value="<?=$data_id ?>" 
                                                    <? if ($arRow['editable'] !== false): ?> title="<?=getMessage('interface_grid_check') ?>" 
                                                        id="checkbox_<?=$arParams["GRID_ID"]?>_<?=$data_id ?>"<? endif ?> 
                                                        <? if (!$arResult['ALLOW_EDIT'] || $arRow['editable'] === false): ?> data-disabled="1" disabled<? endif ?>><?
...
?></div><?
	?><div class="main-grid-bottom-panels" id="<?=$arParams["GRID_ID"]?>_bottom_panels"><?
        ...
        <?php if (stripos($APPLICATION->GetCurPage(), '/crm/tasks/')!==false):?>
        <div class="main-grid-action-panel" style="">
                    ...
                    <tbody>
                        <tr class="main-grid-control-panel-row">
                            <td class="main-grid-control-panel-cell">
                                <button type="submit" class="main-grid-more-btn submit_btn export_xml" value="xml" name="export_type">VERZEND NAAR ADMINSTRATIE</button>
                                &nbsp;&nbsp;
                                <button type="submit" class="main-grid-more-btn submit_btn export_csv" value="csv" name="export_type">EXPORT CSV</button>
                                <br>
                                <?php/*<a href="#" class="main-grid-more-btn submit_btn export_csv" data-export="xml"><span class="main-grid-more-text">VERZEND NAAR ADMINSTRATIE</span><span class="main-grid-more-load-text">Loading data</span><span class="main-grid-more-icon"></span></a>
                                &nbsp;&nbsp;
                            ...
                            <td class="main-grid-panel-cell main-grid-panel-counter main-grid-cell-left">
                                <div class="main-grid-panel-content main-grid-panel-counter-for-selected">
                                    <span class="main-grid-panel-content-title"></span>&nbsp;
                                    <span class="main-grid-panel-content-text"></span>
                                </div>
                                <div class="main-grid-panel-content main-grid-panel-counter-for-all"></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
