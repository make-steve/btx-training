...
$langFile = GetLangFileName(dirname(__FILE__)."/", "/.description.php", 'de');
if(file_exists($langFile))
	include($langFile);
...
$arPSCorrespondence = array(
		...
		"QUOTE_DE_HEADER_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_HEADER_SHOW"),
				"DESCR" => "",
				"VALUE" => 'Y',
				"GROUP" => 'GENERAL_SETTINGS',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_DE_TOTAL_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_TOTAL_SHOW"),
				"DESCR" => "",
				"VALUE" => 'Y',
				"GROUP" => 'GENERAL_SETTINGS',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_DE_SIGN_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_SIGN_SHOW"),
				"DESCR" => "",
				"VALUE" => 'Y',
				"GROUP" => "SELLER_COMPANY",
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_DE_COLUMN_NUMBER_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_DE_COLUMN_NUMBER_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_DE_COLUMN_NUMBER_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 4600
			),
		"QUOTE_DE_COLUMN_NUMBER_SORT" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 100,
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
		...
		"QUOTE_DE_COLUMN_NUMBER_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_DE_COLUMN_NAME_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_DE_COLUMN_NAME_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_DE_COLUMN_NAME_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 4900
			),
		"QUOTE_DE_COLUMN_NAME_SORT" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 200,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_NAME_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_QUANTITY_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_DE_COLUMN_QUANTITY_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_DE_COLUMN_QUANTITY_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 5200
			),
		"QUOTE_DE_COLUMN_QUANTITY_SORT" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 300,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_QUANTITY_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_MEASURE_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_DE_COLUMN_MEASURE_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_DE_COLUMN_MEASURE_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 5500
			),
		"QUOTE_DE_COLUMN_MEASURE_SORT" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 400,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_MEASURE_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_PRICE_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_DE_COLUMN_PRICE_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_DE_COLUMN_PRICE_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 5800
			),
		"QUOTE_DE_COLUMN_PRICE_SORT" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 500,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_PRICE_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_VAT_RATE_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_DE_COLUMN_VAT_RATE_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_DE_COLUMN_VAT_RATE_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 6100
			),
		"QUOTE_DE_COLUMN_VAT_RATE_SORT" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 600,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_VAT_RATE_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_DISCOUNT_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_DE_COLUMN_DISCOUNT_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_DE_COLUMN_DISCOUNT_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 6400
			),
		"QUOTE_DE_COLUMN_DISCOUNT_SORT" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 700,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_DISCOUNT_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_SUM_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_DE_COLUMN_SUM_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_DE_COLUMN_SUM_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 6700
			),
		"QUOTE_DE_COLUMN_SUM_SORT" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 800,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_DE_COLUMN_SUM_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_DE_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
