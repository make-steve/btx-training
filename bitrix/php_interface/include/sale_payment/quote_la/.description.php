...
$langFile = GetLangFileName(dirname(__FILE__)."/", "/.description.php", 'la');
if(file_exists($langFile))
	include($langFile);
...
$arPSCorrespondence = array(
		...
		"QUOTE_LA_HEADER_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_LA_HEADER_SHOW"),
				"DESCR" => "",
				"VALUE" => 'Y',
				"GROUP" => 'GENERAL_SETTINGS',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_LA_TOTAL_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_LA_TOTAL_SHOW"),
				"DESCR" => "",
				"VALUE" => 'Y',
				"GROUP" => 'GENERAL_SETTINGS',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_LA_SIGN_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_LA_SIGN_SHOW"),
				"DESCR" => "",
				"VALUE" => 'Y',
				"GROUP" => 'SELLER_COMPANY',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_LA_COLUMN_NUMBER_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_LA_COLUMN_NUMBER_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_LA_COLUMN_NUMBER_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 4600
			),
		"QUOTE_LA_COLUMN_NUMBER_SORT" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 100,
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
		...
		"QUOTE_LA_COLUMN_NUMBER_SHOW" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_LA_COLUMN_NAME_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_LA_COLUMN_NAME_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_LA_COLUMN_NAME_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 4900
			),
		...
		"QUOTE_LA_COLUMN_QUANTITY_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_LA_COLUMN_QUANTITY_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_LA_COLUMN_QUANTITY_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 5200
			),
		...
		"QUOTE_LA_COLUMN_MEASURE_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_LA_COLUMN_MEASURE_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_LA_COLUMN_MEASURE_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 5500
			),
		...
		"QUOTE_LA_COLUMN_PRICE_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_LA_COLUMN_PRICE_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_LA_COLUMN_PRICE_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 5800
			),
		...
		"QUOTE_LA_COLUMN_VAT_RATE_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_LA_COLUMN_VAT_RATE_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_LA_COLUMN_VAT_RATE_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 6100
			),
		...
		"QUOTE_LA_COLUMN_DISCOUNT_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_LA_COLUMN_DISCOUNT_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_LA_COLUMN_DISCOUNT_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 6400
			),
		...
		"QUOTE_LA_COLUMN_SUM_TITLE" => array(
				"NAME" => GetMessage("SBLP_Q_LA_COLUMN_TITLE").'"'.GetMessage("SBLP_Q_LA_COLUMN_SUM_VALUE").'"',
				"DESCR" => "",
				"VALUE" => GetMessage("SBLP_Q_LA_COLUMN_SUM_VALUE"),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 6700
			),
