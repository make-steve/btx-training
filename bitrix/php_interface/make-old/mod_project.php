...
class Project
{
    ...
    public $dealUF = array(
        'UF_CRM_1504810715' => 'KLANT_NAAM',
        'UF_CRM_1493724413' => 'TECHNOLOGIE',
    );
    public $companyUF = array(
        'UF_CRM_1504956205' => 'BEZOEKADRES',
        'UF_CRM_1504956215' => 'POSTCODE',
        'UF_CRM_1504956221' => 'PLAATS',
        'UF_CRM_1504956231' => 'FACTUURBEDRIJF',
        'UF_CRM_1504956238' => 'FACTUURADRES',
        'UF_CRM_1504956247' => 'TAV'
    );
    public $contactUF = array(
        'UF_CRM_1504956371' => 'POSTADRES',
        'UF_CRM_1504956378' => 'POSTCODE',
        'UF_CRM_1504956383' => 'PLAATS'
    );
    ...
    public function getList($arFilter)
    {
        ...
        $arProjectList['DATA'] = $this->getProjectDetail($arProjectIds);
    ...
    public function getProjectDetail($projecIds = array(), $getTask = false) {
        ...
        $dbGetProject = 'SELECT p.*,'.
                        ...
                        'WHERE p.`ID` IN ("'.implode('","', $projecIds).'") AND p.`ACTIVE` = "Y"';
    ...
    private function buildProjectFilter($arFilter) {
        ...
        foreach($arFilter as $key => $filter) {
            ...
            if (stripos($key, '%')===0) {
                ...
                $_filter[] = "`".$key."` LIKE '%".$this->_DB->ForSql($filter)."%'";
            } else {
        ...
        return (!empty($_filter) && count($_filter) > 0) ? "WHERE ".implode(" AND ", $_filter) : "";
    }
