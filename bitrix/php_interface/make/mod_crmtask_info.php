...
class mod_task_data {
	...
	private $formShownFields = array(
			CUF_T_INKOMSTEN,
			CUF_T_KOSTEN_DERDEN,
			CUF_T_KOSTEN_LIFT,
			CUF_T_KOSTEN_UREN_IF,
			CUF_T_KOSTEN_UREN_BREAKDOWN_ID,
			CUF_T_RENDEMENT,
			CUF_T_TECHNOLOGY,
			CUF_T_PRODUCTGROUP,
			CUF_T_FACTUUR_MOMENTEN,
			CUF_T_REF_CLIENT,
			// CUF_T_ADDTL_INFO,
			CUF_T_WBSO,
			CUF_T_TYPE,
	 ...
	 static public function shownFields()
	 {
		 $self = new self;
		 return $self->formShownFields;
	 }
