...
?><?$APPLICATION->IncludeComponent("bitrix:intranet.search", ".default", array(
	...
	"CACHE_TYPE" => "A",
	"CACHE_TIME" => "3600000",
	"DATE_FORMAT" => (LANGUAGE_ID == "en") ? "M j, Y" : ((LANGUAGE_ID == "de") ? "d.m.Y" : "d.m.Y"),
	"DATE_FORMAT_NO_YEAR" => (LANGUAGE_ID == "en") ? "M j" : ((LANGUAGE_ID == "de") ? "d.m" : "d.m"),
	"DATE_TIME_FORMAT" => (LANGUAGE_ID == "en") ? "M j, Y H:i:s" : ((LANGUAGE_ID == "de") ? "d.m.Y H:i:s" : "d.m.Y H:i:s"),
	"SHOW_YEAR" => "Y",
