...
if(CModule::IncludeModule('voximplant'))
{
	$aMenuLinks = Array(
		Array(
			...
			"/site_ou/services/telephony/lines.php",
		...
		Array(
			...
			"/site_ou/services/telephony/index.php",
		...
		Array(
			...
			"/site_ou/services/telephony/users.php",
			Array(),
		...
		Array(
			...
			"/site_ou/services/telephony/groups.php",
		...
		Array(
			...
			"/site_ou/services/telephony/phones.php",
			Array(),
		...
		Array(
			...
			"/site_ou/services/telephony/permissions.php",
		...
		Array(
			...
			"/site_ou/services/telephony/ivr.php",
		...
		Array(
			...
			"/site_ou/services/telephony/configs.php",
			Array(),
