...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"G_VIDEO_IBLOCK_ID"=>"21",
		"G_VIDEO_PATH_TO_FILE"=>"67",
		"G_VIDEO_DURATION"=>"68",
		"G_VIDEO_SECTION_ID"=>"231",
		"G_VIDEO_ELEMENT_ID"=>"89",
		"G_VIDEO_WIDTH"=>"400",
		"G_VIDEO_HEIGHT"=>"300",
		...
		"G_LIFE_ACTIVE_DATE_FORMAT" => (LANGUAGE_ID == "en") ? "F j, Y" : ((LANGUAGE_ID == "de") ? "j. F Y" : "d.m.Y"),
		"G_OFFICIAL_ACTIVE_DATE_FORMAT" => (LANGUAGE_ID == "en") ? "F j, Y" : ((LANGUAGE_ID == "de") ?  "j. F Y" : "d.m.Y"),
		"GU_BLOG_DATE_TIME_FORMAT" => (LANGUAGE_ID == "en") ? "F j, Y h:i a" : ((LANGUAGE_ID == "de") ? "j. F Y H:i:s" : ""),
		"GU_FORUM_DATE_TIME_FORMAT" => (LANGUAGE_ID == "en") ? "F j, Y h:i a" : ((LANGUAGE_ID == "de") ? "j. F Y H:i:s" : ""),
		"GU_WORKGROUPS_DATE_TIME_FORMAT" => (LANGUAGE_ID == "en") ? "F j, Y" : ((LANGUAGE_ID == "de") ? "j. F Y" : "d.m.Y H:i:s"),
